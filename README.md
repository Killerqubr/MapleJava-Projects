...
{
  "RepoInfo": {
    "Name": "MapleJava-Projects",
    "Owner": "Killerqubr and flizc",
    "Language" : "Java",
    "Type": "Public, Not Long-Term-Support"
  },
  "Projects": {
    "MapleBox": {
      "Author": "Killerqubr",
  ...
  "About us": {
    "Killerqubr": {
      "age": 16,
      "Favorite-Thing": "Maple and Wind",
      "Favorite-Game": "Minecraft Java Edition",
      "QQ": 1955396107,
      "email": "RKillerqubr@outlook.com"
      },
    "flizc": {
      "age": 16,
...
- ``[7d643a0]`` 推出3N+1项目 | 包括``basic, pro, max``模式
- ``[7d643a0]`` 移除了``ultra``模式
